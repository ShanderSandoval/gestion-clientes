...
const ClienteTable = ({ clientes, onEdit, onDelete, onShowDirecciones }) => {
      ...
      <table className="table table-bordered text-center" style={{ tableLayout: "fixed", width: "100%" }}>
        <thead className="table-dark">
          <tr>
            ...
            <th style={{ width: "25%" }}>Dirección Principal</th> {/* 🔹 Mostramos la dirección principal */}
              ...
              <tr key={cliente.idCliente}>
                ...
                <td>
                  {cliente.direcciones && cliente.direcciones.length > 0
                    ? `${cliente.direcciones[0].direccion}, ${cliente.direcciones[0].ciudad}`
                    : "Sin dirección"}
                </td> {/* ✅ Mostramos la primera dirección si existe */}
